...
Kun Data provides real-time market data for Japan through a token-authenticated API stack designed for charting tools, watchlists, market overview pages, brokerage dashboards, and quant workflows.

This repository focuses on Japan market coverage with support for TSE, NSE.

## API Capabilities

- Real-time WebSocket market data for Japan
...
This repository is designed to make Japan market API coverage easier to discover and evaluate.

## Links

- Website: https://kun.pro/markets/japan-stock-market-api
