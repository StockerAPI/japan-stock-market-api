...
public class Main {
    ...
    private static final String MARKET = "JP";
    private static final String EXCHANGE = "TSE";
    private static final String SYMBOL = "TSE:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"TSE:000040\",\"TSE:005930\"],\"replay\":\"last\"}";
